...
public class Main {
	...
	{
		String text = "4684CB0813E12330";
		String key = "4946583937505744";
...
//			"\nCipher Text: " + text.toUpperCase() + "\n");
		...
		String hexToText = text;
		//byte[] bytes = hexStringToByteArray(hexToText);
		
		byte[] bytes = Hex.decodeHex(hexToText.toCharArray());
		String stB = new String(bytes, StandardCharsets.UTF_8);
		System.out.println("DEU CERTO? " + stB);
		
		//String st = new String(bytes, StandardCharsets.UTF_8);
		//System.out.println("DEU CERTO? " + st);
